    ...
    <el-table border :data="list">
      ...
      <el-table-column label="操作">
        <template slot-scope="{row,$index}">
          ...
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="deletTradeMark(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="tmForm.id?'修改品牌':'添加品牌'" :visible.sync="dialogFormVisible">
      <el-form :model="tmForm" style="width:80%" :rules="rules" ref="ruleForm">
        ...
        <el-form-item label="品牌LOGO" label-width="100px" prop="logoUrl">
          <el-upload class="avatar-uploader" action="/brand-api/admin/product/fileUpload" :show-file-list="false"
